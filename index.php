...
<head>
    ...
    <meta name="description" content="Le Gala IMT Atlantique - campus Nantes se déroulera le 10 Novembre 2017 à Nantes.">
...
<body>
    ...
    <nav>
        <ul>
            <li><img src="img/logo-gala2017-blanc.png" id="logo-menu" alt=""/></li>
    ...
    <section id="home">
        ...
        <img id="gala-logo" src="img/logo-gala2017-noir.png" alt=""/>
        <h3 id="gala-date">Vendredi 10 Novembre</h3>
    </section>
    ...
    <div id="artists-wrapper">
        ...
        <section id="artists">
            ...
            <ul>
                <li><img src="img/yall.jpg" width="230" alt=""/></li>
                <li>dj shirp</li>
                <li>tourist trap</li>
            </ul>
        ...
        <div class="section-content">
            ...
            <div id="animation-description">
                ...
                <div class="animation-element" id="bars">
                    ...
                    <p>Les étudiants de première année vous attendent dans leurs bars, où ils auront imaginé et créé un univers autour du thème VOYAGE.</p>
                </div>
                ...
                <div class="animation-element" id="massage">
                    <h3 class="underline">Massage</h3>
                    <p>Besoin d'un moment de détente ? Les étudiants de l'Ecole de Kiné de Nantes seront là pour proposer des massages, tout au long de la soirée.</p>
                </div>
    ...
    <section id="billeterie">
        ...
        <div class="section-content">
            ...
            <a class="ticket-sale-point" href="https://pro.pumpkin-app.com/pay/Gala2017IMTA">
                en <br/>
            ...
            <div class="ticket-sale-point">
                <img src="img/logo-gala2017-blanc.png" id="logo-tickets" alt=""/>
            </div>
        </div>
    </section>
    ...
    <section id="sponsors">
        ...
        <div class="section-content">
            <div class="sponsor-element">
                <img src="img/sponsors/mind.png" width="110" alt="">
            </div>
            <div class="sponsor-element">
                <img src="img/sponsors/virgin.png" width="60" alt="">
            </div>
            <div class="sponsor-element">
                <img src="img/sponsors/pumpkin.png" width="100" alt="">
            </div>
            <div class="sponsor-element">
                <img src="img/sponsors/fa.png" width="120" alt="">
            </div>
            <div class="sponsor-element">
                <img src="img/sponsors/soonnight.png" width="120" alt="">
            </div>
            <div class="sponsor-element">
                <img src="img/sponsors/soge.png" width="90" alt="">
            </div>
            <div class="sponsor-element">
                <img src="img/sponsors/sodebo.png" width="80" alt="">
            </div>
            <div class="sponsor-element">
                <img src="img/sponsors/lalanne.png" width="90" alt="">
            </div>
        </div>
